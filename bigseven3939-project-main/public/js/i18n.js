// =====================================================
// Từ điển song ngữ cho các nhãn giao diện (UI labels)
// Bilingual dictionary for UI labels
// 📝 Thêm/sửa key tại đây nếu cần
// =====================================================
const I18N = {
  vi: {
    ...
    blog: { title: 'Blog', read: 'Đọc bài viết →' },
    contact: { title: 'Liên hệ', desc: 'Bạn muốn trao đổi về bảo mật, SOC hay cơ hội thực tập? Hãy liên hệ với mình!' },
  ...
  en: {
    ...
    hero: {
      ...
      desc: 'I am an Information Security student with hands-on experience in SIEM deployment, security monitoring, network infrastructure, and web application security assessment. My learning journey combines academic knowledge, home lab experimentation, cybersecurity certifications, and real-world project development.',
    ...
    blog: { title: 'Blog', read: 'Read post →' },
    contact: { title: 'Contact', desc: 'Want to talk security, SOC or internship opportunities? Get in touch!' },
    footer: { tagline: '“Continuous learning, practical experience, and a passion for cybersecurity.”' }
  }
};
